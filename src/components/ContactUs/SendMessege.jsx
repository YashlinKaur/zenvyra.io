    ...
    <div className="relative w-full min-h-screen bg-[#080808] text-white px-4 sm:px-6 lg:px-[3vw] py-10 flex flex-col lg:flex-row gap-10 overflow-hidden">
        ...
        {features.map((item, index) => (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-8 w-[75px] h-[75px] border border-[#2d2d2d] rounded-full flex justify-center items-center text-[32px] text-[#b5f364] bg-[#080808] shadow-[0_0_30px_rgba(181,243,100,0.08)]"
            >
              {item.icon}
            </motion.div>
      ...
      >
        ...
        <motion.h1
          ...
          viewport={{ once: true }}
          className='text-[24px] sm:text-[30px] uppercase font-["Inter"] text-[#f3f3f3] mb-2 tracking-wide'
        >
          Send Us A Message
        </motion.h1>
        ...
        <motion.button
          ...
          className='bg-[#b5f364] text-black hover:bg-[#1a2418] hover:text-white font-semibold uppercase py-4 font-["Inter"] w-full rounded-xl transition-all duration-300 tracking-wide text-[15px] sm:text-[16px]'
        >
          Send Message
        </motion.button>
