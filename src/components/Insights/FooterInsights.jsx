  ...
  return (
    <div className="w-full bg-black text-white px-4 sm:px-6 lg:px-[3vw] py-10 lg:py-[5vh] overflow-hidden">
      <motion.div
        ...
        viewport={{ once: true }}
        className="w-full border border-[#26352b] rounded-3xl p-6 sm:p-8 lg:p-[2vw] flex flex-col lg:flex-row items-center justify-between gap-12 bg-[#101a14]/40 backdrop-blur-md"
      >
        {/* Left Icon Section */}
        ...
        <div className="w-full lg:w-[40%] text-center lg:text-left">
          ...
          <p className="text-[15px] sm:text-[18px] lg:text-[19px] text-[#bdbdbd] leading-relaxed">
            Subscribe to our newsletter and get the latest articles, trends, and
          ...
          {!subscribed ? (
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center border border-[#3a4a40] rounded-3xl overflow-hidden bg-[#0f1712]">
              <input
                ...
                className="w-full bg-transparent px-5 py-4 text-white placeholder:text-gray-500 focus:outline-none text-[15px] sm:text-[17px]"
              />

              <button
                onClick={handleSubscribe}
                className="bg-[#b5f364] text-black px-8 py-4 uppercase font-semibold hover:bg-[#d4ff98] transition-all duration-300"
              >
                Subscribe
              </button>
            </div>
          ) : (
            <div className="border border-[#b5f364] rounded-3xl py-4 px-6 text-center bg-[#0f1712]">
              <h2 className="text-[#b5f364] text-xl font-semibold">
                ✓ Subscribed
              </h2>
            </div>
          )}

          <h1 className="text-[14px] sm:text-[16px] text-[#8f8f8f] text-center sm:text-left">
