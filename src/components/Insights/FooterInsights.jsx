    ...
    <div className="w-full bg-black text-white px-4 sm:px-6 lg:px-[3vw] py-10 lg:py-[5vh] overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className='w-full lg:w-[40%] font-["Inter"] text-center lg:text-left'
        >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center border border-[#3a4a40] rounded-3xl overflow-hidden bg-[#0f1712]">
            ...
            <button className="bg-[#b5f364] text-black px-8 py-4 uppercase font-semibold hover:bg-[#d4ff98] hover:scale-[1.03] transition-all duration-300 text-[14px] sm:text-[15px]">
              Subscribe
            </button>
          </div>
