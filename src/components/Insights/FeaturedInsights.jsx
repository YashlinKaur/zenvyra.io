...
function FeaturedInsights() {
  ...
  return (
    <div className="w-full min-h-screen bg-black px-4 sm:px-6 lg:px-[4vw] py-8 sm:py-[10vh] lg:py-[7vh] text-white overflow-hidden">
      
      {/* Browse Topics */}
      <div className="border border-[#2a3a30] rounded-3xl backdrop-blur-md bg-[#101a14]/40">
        ...
        <div className="w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 px-5 lg:px-[2vw] py-5">
          ...
          <button className="px-5 py-2 uppercase border border-[#4f5a52] text-[13px] sm:text-[15px] rounded-2xl flex items-center gap-2 hover:bg-[#b5f364] hover:text-black transition-all duration-300">
            View All Articles
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-4 px-4 pb-6">
          {topics.map((topic, index) => (
            ...
            >
              <div className="text-[32px] sm:text-[38px] text-[#b5f364] group-hover:scale-110 transition-all duration-300">
                {topic.icon}
              </div>
      ...
      {/* Featured Insights */}
      <div className="w-full mt-14 flex flex-col lg:flex-row gap-10 items-center">
        ...
        <div className="w-full lg:w-[45%]">
          ...
          {/* CTA */}
          <div className="text-[17px] sm:text-[20px] mt-10 font-semibold uppercase flex items-center gap-3 cursor-pointer group">
        ...
        {/* Right Image */}
        <div className="w-full lg:w-[55%] h-[300px] sm:h-[450px] lg:h-[550px] border border-[#2d3a31] rounded-3xl overflow-hidden shadow-[0_0_40px_rgba(181,243,100,0.08)]">
          <img src="insights.png" alt="Featured Insights" className="w-full h-full object-cover hover:scale-105 transition-all duration-700"/>
        </div>
      </div>
    </div>
  );
